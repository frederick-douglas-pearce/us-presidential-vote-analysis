...
The common misconception is that Congress fixed the House at 435 members in 1929. The [Permanent Apportionment Act of 1929](https://www.govinfo.gov/content/pkg/STATUTE-46/pdf/STATUTE-46-Pg21.pdf) never says that: the number 435 doesn't appear anywhere in its text. What it does instead is make reapportionment self-executing. After each census the seats are redistributed among the states automatically, unless Congress passes an apportionment of its own. The number being redistributed is whatever the House already has, "the then existing number of Representatives." The Act didn't write a ceiling, it made reapportionment the default.
